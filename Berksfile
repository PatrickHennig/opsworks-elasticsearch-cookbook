...
cookbook 'java', '>= 1.19.2', git: 'git://github.com/PatrickHennig/java.git', tag: 'v1.21.2'
...
cookbook 'elasticsearch', git: 'git://github.com/PatrickHennig/cookbook-elasticsearch.git', tag: '0.3.7'
